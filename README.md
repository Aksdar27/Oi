...
XAUUSD AI Core adalah platform analisis dan agent autonomous untuk Auto-Scalping berbasis **Smart Money Concepts (SMC)** dengan intervensi kendali penuh dari Gemini AI.
...
GEMINI_API_KEY=AIzaSy...               # Kunci utama untuk Google Gemini

# Data Feed & Filter
TWELVEDATA_API_KEY=xxxxxxxx            # Websocket Market Data (Saham, Forex, Crypto)
NEWS_API_KEY=xxxxxxxx                  # API Key dari NewsAPI (opsional)

# GitHub Sync & CLI AI Actions
GITHUB_TOKEN=ghp_xxxxxxxxx             # Personal Access Token GitHub (Wajib centang repo access)
GITHUB_REPO_OWNER=UsernameGitHubUser   # Username/Owner repo github kamu
GITHUB_REPO_NAME=xsmc-repo             # Nama repository ini berdiri
